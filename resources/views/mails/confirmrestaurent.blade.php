...
<p>Chúng tôi trân trọng mời Anh/Chị đến dùng bữa tại: “{{ $email_data['store']->translate('vi')->store_name }}” trước <strong style="color: red">{{ $email_data['check_in'] }}</strong>, vui lòng nhẫn nút chọn cuối thư mời xác nhận tham gia hoặc từ chối, như vậy sẽ thuận tiện cho chúng tôi sắp xếp mời khách hàng khác trong khoảng thời gian mà Anh/Chị không tham gia được</p>
...
<ul style="padding-left: 15px">
    <li>Nhà hàng Alfresco’s: nam và nữ: Sơ mi trắng hoặc đen</li>
    <li>Nhà hàng Pepperonis: nam và nữ : Sơ mi trắng hoặc đen</li>
    <li>Nhà hàng Jaspas: nam và nữ: sơ mi trắng hoặc đen</li>
    <li>Nhà hàng Papa Joes: nam và nữ: sơ mi trắng hoặc đen</li>                      
</ul>
...
<p>2. Với câu trả lời “NO”, anh chị vui lòng điền lý do vào ô bên cạnh câu trả lời.</p>
...
<p><img src="http://afg.huho.com.vn/images/brands/afg.png" width="320" alt="AFG Vietnam"></p>
