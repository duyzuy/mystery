...
<p>We would like you to visit “<strong>{{ $email_data['store']->translate('vi')->store_name }}, {{ $email_data['store']->translate('en')->store_address }} </strong>” before <strong style="color: red">{{ $email_data['check_in'] }}</strong>, please respond by <strong>12:00 pm tomorrow</strong>. If you are unable to visit, this will enable us to find another guest to attend.</p>
...
<ul style="padding-left: 15px">
    <li><span style="display: inline-block; width: 150px">Alfresco's: </span><span>Female & Male: Black or White Shirt</span></li>
    <li><span style="display: inline-block; width: 150px">Pepperonis: </span><span>Female & Male: Red or White Shirt</span></li>
    <li><span style="display: inline-block; width: 150px">Jaspas: </span><span>Male & Female: White shirt or Blue shirt</span></li>
    <li><span style="display: inline-block; width: 150px">Jacksons Steakhouse: </span><span>Female & Male: White Shirt</span></li>
    <li><span style="display: inline-block; width: 150px">Papa Joes: </span><span>Male & Female: White shirt</span></li>
</ul>
...
<ul style="padding-left: 15px">
    <li><span style="display: inline-block; width: 150px">Jacksons Steakhouse: </span><span>1,000,000 VND (<i>One million Vietnam Dong)</i></span></li>
    <li><span style="display: inline-block; width: 150px">Jaspas: </span><span>700,000 VND <i>(Seven hundred thousand Vietnam Dong)</i></span></li>
    <li><span style="display: inline-block; width: 150px">Alfresco’s: </span><span>600,000 VND <i>(Six hundred thousand Vietnam Dong)</i></span></li>
    <li><span style="display: inline-block; width: 150px">Pepperonis: </span><span>400,000 VND <i>(Four hundred thousand Vietnam Dong)</i></span></li>
    <li><span style="display: inline-block; width: 150px">Papa Joes: </span><span>400,000 VND <i>(Four hundred thousand Vietnam Dong)</i></span></li>
</ul>
...
<p><a href="{{ route( 'user.page.confirmation', [$email_data['locale'], $email_data['token']] ) }}" style="color: Green;">Please kindly confirm Yes or No here</a></p>
<br>
<p>Thank you,</p>
<table>
...
<p><img src="https://guestsurvey.afg.vn/images/email-footer.png" width="320" alt="AFG Vietnam"></p>
