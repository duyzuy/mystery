...
class UserController extends Controller
{
    ...
    */
    ...
    public function userResponseEmail(UserConfirmationRequest $request, $lang)
    {
        ...
        $userStore->response_status = $answer;

        $userStore->update();

        //send email notify admin
        MailController::sendUserConfirmEmail($user->name, $user->email, $answer, $store);


        //send Email confirm to user
        MailController::sendUserConfirmed($user->name, $user->email, $password, $user->locale, $answer);
    ...
    public function userConfirmation($lang, $token)
    {
        ...
        //dd($userStore);
        return view('frontend.user.confirmation', compact(['userStore', 'store', 'user']));
